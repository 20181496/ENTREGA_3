...
+ Este breve reporte tiene como objetivo hacer un analizis de correlacion entre el desempleo juvenil (de jovenes de 16 a 24 años) con la infraestructura de carreteras, la obesidad en adultos, la inversion extranjera, los gastos en educacion publica y el PBI de 160 paises en el año 2018. Esto se realizara por medio de la creacion de modelos de regresion lineal para ver cuales variables tienen un impacto sobre la variable dependiente (Desempleo juvenil). 
